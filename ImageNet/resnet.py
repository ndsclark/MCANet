...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, use_attention=False):
        ...
        if use_attention:
            ...
            # self.attention = ECALayer(planes)
            # self.attention = SRMLayer(planes)
            # self.attention = TripletAttention()
            # self.attention = CALayer(planes)
            # self.attention = SALayer(planes)
            # self.attention = SGELayer()
        else:
            self.attention = None
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, use_attention=False):
        ...
        if use_attention:
            ...
            # self.attention = TripletAttention()
            # self.attention = CALayer(planes * self.expansion)
