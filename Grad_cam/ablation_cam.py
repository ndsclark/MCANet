...
class AblationCAM(BaseCAM):
    def __init__(self, model, target_layer, use_cuda=False, reshape_transform=None):
        super(AblationCAM, self).__init__(model, target_layer, use_cuda, reshape_transform)
    ...
    def get_cam_weights(self,
        ...
        ablation_layer = AblationLayer(self.target_layer, self.reshape_transform, indices=[])
